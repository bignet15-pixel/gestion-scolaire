<x-app-layout>
{{--resources/views/annee_scolaires/create.blade.php --}}
    <div class="container">
        <div class="card">
            ...
            <form action="{{ route('annee-scolaires.store') }}" method="POST">
                {{-- Jeton de securite du formulaire. --}}
                @csrf

                <div class="form-group">
                    <label class="form-label">Libellé</label>
                    <input type="text" name="libelle" class="form-control" placeholder="Ex: 2025-2026" value="{{ old('libelle') }}">
                </div>
