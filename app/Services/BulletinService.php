...
class BulletinService
{
    ...
    public function bulletinTrimestriel(Inscription $inscription, Trimestre $trimestre): array
    {
        ...
        return [
            ...
            'total_points_en_moins_visibles' => $resultat['total_points_en_moins_visibles'] ?? $resultat['total_points_en_moins'],
            'total_points_en_moins_en_cours' => $resultat['total_points_en_moins_en_cours'] ?? 0,
            'total_points_en_moins_definitifs' => $resultat['total_points_en_moins_definitifs'] ?? $resultat['total_points_en_moins'],
